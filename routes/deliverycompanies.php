...
use App\Http\Controllers\Deliverycompany\v1\vehilceallocationController;
...
Route::middleware(['auth:api-delivery-company'])->group(function () {
    Route::group(['prefix' => 'v1'], function () {
        ...
        Route::post('delivery-company/driver-allocate', [vehilceallocationController::class, 'allocate']);
